class Solution {
    public boolean isValidSudoku(char[][] board) {
        //pour resoudre il faut que le sodukou check 3 condition.
        //1. pas de meme nombre dans la meme ligne -> for i pas meme element
        //2. pas de meme nombre dans la meme colonne -> for j pas de meme element
        //3. pas de meme element dans le carre.
